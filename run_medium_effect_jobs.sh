#!/bin/bash
#SBATCH -J run_medium_effect_jobs
...
#SBATCH -o logs/run_medium_effect_jobs-%j.out
...
python3 -m snakemake -c 8 --nolock --keep-going --use-conda --scheduler greedy run_medium_effect_jobs
