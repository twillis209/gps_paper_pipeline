...
mixed_effect_rg_estimate_files  = [f"results/ldsc/rg/whole_genome/randomised/{size[0]}_{size[1]}_{size[2]}_{size[3]}/{effect_tuple}_seed_%d_{tag_pair}.log" for size in mixed_effect_sample_sizes for tag_pair in tag_pairs for effect_tuple in mixed_effect_tuples]

mixed_effect_rg_estimate_free_h2_free_rg_files = [f"results/ldsc/rg/free_h2_free_rg_intercept/whole_genome/randomised/{size[0]}_{size[1]}_{size[2]}_{size[3]}/{effect_tuple}_seed_%d_{tag_pair}.log" for size in mixed_effect_sample_sizes for tag_pair in tag_pairs for effect_tuple in mixed_effect_tuples]
...
mixed_effect_rg_estimate_fixed_h2_fixed_rg_files = [f"results/ldsc/rg/fixed_h2_fixed_rg_intercept/whole_genome/randomised/{size[0]}_{size[1]}_{size[2]}_{size[3]}/{effect_tuple}_seed_%d_{tag_pair}.log" for size in mixed_effect_sample_sizes for tag_pair in tag_pairs for effect_tuple in mixed_effect_tuples]
...
seeded_mixed_effect_rg_estimate_free_h2_free_rg_files = [x[0] % x[1] for x in zip(mixed_effect_rg_estimate_free_h2_free_rg_files, range(9000, 9000+len(mixed_effect_rg_estimate_free_h2_free_rg_files)))]
...
seeded_mixed_effect_rg_estimate_fixed_h2_fixed_rg_files = [x[0] % x[1] for x in zip(mixed_effect_rg_estimate_fixed_h2_fixed_rg_files, range(9000, 9000+len(mixed_effect_rg_estimate_fixed_h2_fixed_rg_files)))]

seeded_mixed_effect_rg_estimate_free_h2_fixed_rg_files = [x[0] % x[1] for x in zip(mixed_effect_rg_estimate_free_h2_fixed_rg_files, range(9000, 9000+len(mixed_effect_rg_estimate_free_h2_fixed_rg_files)))]
