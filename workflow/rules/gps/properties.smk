...
rule compile_top_maximands_for_ukbb_traits:
    input:
        annot_files = [f"results/gps/{{snp_set}}/{{variant_set}}/window_1000kb_step_50_r2_0_2/{trait_pair}_intermediates_annot.tsv" for trait_pair in ukbb_trait_pairs],
        pvalue_files = [f"results/gps/{{snp_set}}/{{variant_set}}/window_1000kb_step_50_r2_0_2/{trait_pair}_3000_permutations_gps_pvalue.tsv" for trait_pair in ukbb_trait_pairs]
    output:
        "results/gps/combined/{snp_set}/{variant_set}/window_1000kb_step_50_r2_0_2/compiled_top_maximands.tsv"
    threads: 4
    group: "gps"
