#!/bin/bash
#SBATCH -J run_mixed_effect_jobs
...
#SBATCH -o logs/run_mixed_effect_jobs-%j.out
...
python3 -m snakemake -c 40 --keep-going --use-conda --nolock --scheduler greedy --rerun-incomplete run_mixed_effect_jobs
