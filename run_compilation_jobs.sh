...
#SBATCH -o logs/run_compilation_jobs-%j.out
#SBATCH -e logs/run_compilation_jobs-%j.err
...
python3 -m snakemake -c 4 --keep-going --use-conda --nolock --scheduler greedy --rerun-incomplete compile_results
